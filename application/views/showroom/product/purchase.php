             ...
             <div class="col-md-12">
                 ...
                 <div class="box box-primary">
                     ...
                     <div class="box-header with-border">
                         <h2 cstyle="text-align:center;">Purchase Sale</h2>
                     ...
                     <form role="form" data-toggle="validator" action="<?= site_url()?>Showroom/insert_purchase_data/<?php echo $company_details[0]->Per_id;?>" method="post">
                         ...
                         <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="name"  class="form-control" value="<?php if($company_details){echo $company_details[0]->Per_name; } ?>"  id="exampleInputEmail1" placeholder="" required />
                                    <input type="hidden" name="per_id"  class="form-control" value="<?php if($company_details){echo $company_details[0]->Per_id; } ?>" />
                                 ...
                                 <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="cnic"  class="form-control" value="<?php if($company_details){echo $company_details[0]->Per_cnic; } ?>" placeholder="" required />
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
                                 </div>
                                 <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="phone"  class="form-control" value="<?php if($company_details){echo $company_details[0]->Per_number; } ?>" placeholder="" required />
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
                                 </div>
                                 <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="address"  class="form-control" value="<?php if($company_details){echo $company_details[0]->Per_address; } ?>" placeholder="" required />
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
                                 </div>
                                 <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="le_no"  class="form-control" value="<?php if($company_details){echo $company_details[0]->Per_license_no; } ?>" placeholder="" required />
                                     <span class="glyphicon form-control-feedback" aria-hidden="true" style="margin-right: 20px;"></span>
                                     <span class="help-block with-errors" style="margin-left:10px; "></span>
                                 </div>
                                 </div>
                             <div class="col-md-6 col-sm-offset-3">
								...
								<div class="col-md-6 col-sm-offset-3">
                                  ...
                                  <div class="form-group has-feedback form-inline">
                                    <input type="text" name="weapon_no_1"  class="form-control"  id="weapon_no" placeholder="" style="width:90%" required/>
                                ...
                                <!--    <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                     <label>Weapon Number in Stock</label>
