 <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            SSClub Dashboard
            <small> <a href="<?= site_url()?>admin/">Home</a> &nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-circle-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp; <a href="<?= site_url()?>showroom/index">Showroom Section</a> &nbsp;&nbsp;&nbsp;<i class="fa fa-chevron-circle-right" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;Purchase Report Form</small>
         </h1>
        </section>
     <!-- Main content -->
         ...
         <div class="row">
             ...
             <div class="col-md-12">
                 ...
                 <div class="box box-primary">
                     ...
                     <!-- form start -->
                     <form role="form" data-toggle="validator" action="<?= site_url()?>purchase_reports/purchase_reports_search" method="post">
                         <div class="box-body">
                             <div class="col-md-6 col-sm-offset-3">
								 ...
								 <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                    ...
                                    <input type="text" name="cnic"  class="form-control"  id="exampleInputEmail1" placeholder="" maxlength="13" minlength="13" pattern="(?=.*\d).{13,}">
								...
								<div class="col-md-6 col-sm-offset-3">
								 ...
								 <div class="col-md-6 col-sm-offset-3">
                                  <div class="form-group has-feedback">
                                     ...
                                     <select type="text" name="purchase_from" class="form-control" minlength="1" maxlength="50" id="exampleInputEmail1">
