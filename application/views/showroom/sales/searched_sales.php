             ...
             <div class="col-md-12">
                 ...
                 <div class="box box-primary">
                     <div class="box-header with-border">
                         ...
                         <h2 style="text-align:center;">Sale Product Form</h2>
                         <a href="<?= site_url()?>customer/" class="pull-right"> Back</a>
                     </div><!-- /.box-header -->
                     <!-- form start -->
                     <form role="form" data-toggle="validator" action="<?= site_url('sale/insert_sale_data/'.$search_data[0]->Per_id)?>" method="post">
                         <div class="box-body">
                             <div class="col-md-12">
